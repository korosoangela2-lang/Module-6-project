...
export default function LoginScreen() {
  ...
  return (
    <div
      className="flex flex-col items-center p-6 heha-rise"
      style={{ minHeight: "100%" }}
    >
      <div className="w-full" style={{ maxWidth: 640 }}>
        <div className="heha-card">
          <div className="flex flex-col gap-1 mt-8">
            <div className="text-2xl font-semibold" style={{ color: T.pine }}>
              Heha Banking Agency
            </div>
            <div className="text-sm" style={{ color: T.muted }}>
              Send money home, without the markup.
            </div>
          </div>
          <form className="flex flex-col gap-4 mt-4" onSubmit={submit}>
            ...
            <Field label="Password">
              <div className="relative">
                ...
                <button
                  ...
                  onClick={() => setShow((s) => !s)}
                  className="absolute"
                  style={{ right: 10, top: 10, color: T.faint }}
                >
            ...
            <div className="text-xs text-center" style={{ color: T.faint }}>
              Demo user: {DEMO_LOGIN_HINT.user} · Demo admin:{" "}
              {DEMO_LOGIN_HINT.admin}
            </div>
          </form>
          <div className="text-sm text-center mt-4" style={{ color: T.muted }}>
            New to Heha?{" "}
            <button
